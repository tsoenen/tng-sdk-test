...
def testbed():
    with Emulator() as vim:
        vim.add_instance_from_image('client', 'tangoclient')
        vim.add_instance_from_image('server', 'tangoserver')
        vim.add_instance_from_image('firewall', 'tangofirewall', interfaces=['input', 'output'])
        vim.add_instance_from_image('snort', 'tangosnort', interfaces=['input', 'output'])
